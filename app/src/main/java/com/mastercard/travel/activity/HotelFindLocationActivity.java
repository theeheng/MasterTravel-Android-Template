...
import com.mastercard.travel.fragment.HotelFindLocationFragment;

/**
 * Created by ignacio on 16/02/2015.
 */
public class HotelFindLocationActivity extends BaseActivityWithoutToolbar {

    @Override
    public Class<? extends BaseFragment> getFragmentClass() {
        return HotelFindLocationFragment.class;
    }
