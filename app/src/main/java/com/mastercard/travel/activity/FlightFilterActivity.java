...
import com.mastercard.travel.fragment.FlightFilterFragment;

public class FlightFilterActivity extends BaseActivityWithoutToolbar {

    @Override
    public Class<? extends BaseFragment> getFragmentClass() {
        return FlightFilterFragment.class;
    }
