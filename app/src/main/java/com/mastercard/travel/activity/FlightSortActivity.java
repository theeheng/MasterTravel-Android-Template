...
import com.mastercard.travel.fragment.FlightSortFragment;

public class FlightSortActivity extends BaseActivityWithoutToolbar {

    @Override
    public Class<? extends BaseFragment> getFragmentClass() {
        return FlightSortFragment.class;
    }
